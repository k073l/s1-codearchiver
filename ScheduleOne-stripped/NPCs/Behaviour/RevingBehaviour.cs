...
using ScheduleOne.SpecialCustomers.Activity;
using ScheduleOne.Vehicles;
using UnityEngine;

namespace ScheduleOne.NPCs.Behaviour;
public class RevingBehaviour : MoveToAndActBehaviour
{
    private int _motorbikeIndex;
    private Motorbike _motorbike;
    private bool NetworkInitialize___EarlyScheduleOne_002ENPCs_002EBehaviour_002ERevingBehaviourAssembly_002DCSharp_002Edll_Excuted;
    private bool NetworkInitialize__LateScheduleOne_002ENPCs_002EBehaviour_002ERevingBehaviourAssembly_002DCSharp_002Edll_Excuted;
    [ObserversRpc]
    [TargetRpc]
    ...
    private IEnumerator DoDelayRoutine(float delay, Action action);
