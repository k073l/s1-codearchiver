...
public class NPCBehaviour : NetworkBehaviour
{
    ...
    [ServerRpc(RequireOwnership = false)]
    public void ConsumeProduct_Server(ProductItemInstance product, bool removeFromInventory = false);
    private void OnKnockOut();
    private void OnRevive();
    protected virtual void OnDie();
    [ServerRpc]
    public void ResetBehavioursEnableState();
    ...
    private void RpcWriter___Server_ConsumeProduct_Server_3964170259(ProductItemInstance product, bool removeFromInventory = false);
    public void RpcLogic___ConsumeProduct_Server_3964170259(ProductItemInstance product, bool removeFromInventory = false);
    private void RpcReader___Server_ConsumeProduct_Server_3964170259(PooledReader PooledReader0, Channel channel, NetworkConnection conn);
    private void RpcWriter___Server_ResetBehavioursEnableState_2166136261();
    public void RpcLogic___ResetBehavioursEnableState_2166136261();
    private void RpcReader___Server_ResetBehavioursEnableState_2166136261(PooledReader PooledReader0, Channel channel, NetworkConnection conn);
